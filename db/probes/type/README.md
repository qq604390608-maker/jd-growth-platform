...
> TS-11 的策略（应用层校验 or `CHECK` 约束）由你定；本文件提供事实。
...
| `../../../docs/03-locks/tech-stack.md` §3.1 / §3.2 / §3.3、§8 TS-11 | 事实输入：`varchar(n)` 不强制长度、`datetime` 亲和、中文排序、`CHECK` 可用性 | ✅ **已回填（2026-09-19，tech-stack v1.2）**；策略面仍待 TS-11 裁决 |
