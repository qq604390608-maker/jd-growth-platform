...
> **2026-09-21 裁决批次备注**：八条拍板类（TS-12/13/15/16/17/18/19/20）＋ T-24 code 名＋ T-20/T-25 框架确认，已全部裁决并回填 `tech-stack.md` §8 与 `external-deps.md` §7，详见 `ts-decision-requests.md` §四裁决记录。涉及代码的三项中，**T-24 MD-14 回填与 TS-16 截断已落地**（各自独立 PR、全量回归绿）；余 **TS-20 双 Worker 拆分**待下一轮 PR。
