...
| `external-deps.md` | 外部依赖锁定：依赖总表（数据源/Agent 运行能力/交付基础设施三类）· 五系统能力核对七项 · `tool_registry` 文档视图（含 `blocks_features`）· mock server 需求 | ✅ 已有（v1.2 草稿，含待确认清单；§7 仅余 T-01~T-10 + T-22 共 11 条等对接方） |
