...
## 工程状态（2026-09-19，阶段0-工程骨架 → 阶段1 · M2 → 阶段2 · M5 F-23/F-24/F-25）
...
| 模块 | 目录/文件 | 状态 | 服务功能点 |
| ---- | ---- | ---- | ---- |
| `api` | `server/api/index.js` | 🟡 骨架 + F-07~F-12 + **F-23/F-24/F-25** 路由（健康检查 / D1 探测 / 业务背景库接口 / 来源登记接口 / 证据接口 / 机会记录接口 / 研究结果与历史接口 / 上下文注入接口 / 工具注册与权限判定接口 / 工具描述与真实查询接口 / **查询记录落痕与回查接口**） | F-07~F-12 **F-23 F-24 F-25**、F-27~F-32（后续实现） |
...
| `tool-executor` | `server/tool-executor/` | 🟡 部分（**F-23 / F-24 / F-25 已建** 2026-09-19；F-26 待建） | **F-23 F-24 F-25**、F-26 |
